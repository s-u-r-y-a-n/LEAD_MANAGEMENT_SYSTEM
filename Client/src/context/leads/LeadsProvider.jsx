  ...
  const searchAndFilterLeads = useCallback(
    async (filters) => {
      ...
      try {
        ...
        setLeadsStatus("failed");
        setLeadsError(message);
        showError(message, "Unable to search leads");
        throw new Error(message, { cause: error });
      }
    },
    [authorizedConfig, showError, success],
  ...
  const createLead = useCallback(
    async (leadData) => {
      ...
      try {
        ...
        success(response.data.message || "Lead created.", "Lead created");
        ...
        setLeadsError(message);
        showError(message, "Unable to create lead");
        throw new Error(message, { cause: error });
      }
    },
    [authorizedConfig, showError, success],
  ...
  const updateLead = useCallback(
    async (leadId, leadData) => {
      ...
      try {
        ...
        success(response.data.message || "Lead updated.", "Lead updated");
        return response.data;
      } catch (error) {
        const message =
        ...
        setLeadsError(message);
        showError(message, "Unable to update lead");
        throw new Error(message, { cause: error });
      }
    },
    [authorizedConfig, showError, success],
  ...
  const deleteLead = useCallback(
    async (leadId) => {
      ...
      try {
        ...
        success(response.data.message || "Lead deleted.", "Lead deleted");
        return response.data;
      } catch (error) {
        const message =
        ...
        setLeadsError(message);
        showError(message, "Unable to delete lead");
        throw new Error(message, { cause: error });
      }
    },
    [authorizedConfig, showError, success],
